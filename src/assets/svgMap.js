...
function svgMapWrapper(svgPanZoom) {
  ...
  svgMap.prototype.init = function (options) {
    ...
    var defaultOptions = {
      ...
      mouseWheelKeyMessage: 'Presionar [ALT] para hacer zoom',

      // The message to show for MacOS
      mouseWheelKeyMessageMac: 'Presionar [COMMAND] para hacer zoom',
  ...
  svgMap.prototype.countries = {
    ...
    FI: 'Saanjlàedenug',
    FR: 'Franklàedenug',
    GF: 'Franklàedenuges Gujàna',
    PF: 'Franklàedenuges Poljnèsja',
    TF: 'Franklàedenuges Frjweges Laedejugen',
    GA: 'Gabon',
    GM: 'Gambia',
    GE: 'Georgia',
    DE: 'Alämanlàedenug',
    ...
    NU: 'Niue',
    NF: 'Norfolk Kürkaj',
    KP: 'Føjlgorjölàedenug',
    MP: 'Føjleges Marjana Kürkajen',
    NO: 'Føjljonlàedenug',
    OM: 'Oman',
    PK: 'Pakistan',
    PW: 'Palau',
    ...
    TK: 'Tokelau',
    TO: 'Tonga',
    TT: 'Trjnjdàd j Tobàgo',
    TN: 'Tunisia',
    TR: 'Turkey',
    TM: 'Turkmenistan',
    TC: 'Türks j Kajkos Kürkajen',
    TV: 'Tuvalu',
    UG: 'Uganda',
    UA: 'Fändjlàedenug',
    AE: 'United Arab Emirates',
    GB: 'United Kingdom',
    US: 'Ljuweges Laedenugeten tjl Anèrjka',
