...
("Deber, tener que (hacer algo).","Adeudar o estar bajo obligación de cumplir algo.","","",""),
...
("neo. Robot, autómata (máquina que realiza labores humanas).","neo. Androide (robot con fisionomía símil a la humana).","","",""),
...
("Persona, humano.","coloq. Creación noble o bondadosa.","coloq. Proyecto, idea a futuro.","",""),
...
("Riqueza, opulencia, fortuna.","coloq. Prosperidad, auge.","","",""),
